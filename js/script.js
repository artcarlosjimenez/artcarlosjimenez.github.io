...
function buildChain() {
  // Tomar el MP3 del elemento <audio> embebido (ahora es un archivo externo, no un data URI)
  ...
  // Decode & play MP3 with wow/flutter (descarga el archivo externo y lo decodifica)
  fetch(mp3src).then(r => r.arrayBuffer()).then(ab2 => actx.decodeAudioData(ab2)).then(buf => {
...
function openTarotWin(){
  ...
  el.innerHTML=`
    ...
    <div class="xp-addr">
      <span>Ruta</span>
      <div class="xp-addr-field">~/Tarot/index.html</div>
    </div>
    <div class="xp-body" style="flex:1;overflow:hidden;padding:0;">
      <iframe src="tarot/index.html" style="width:100%;height:100%;border:none;display:block;"
